module net.jqwik.engine {
  ...
  provides net.jqwik.api.Arbitraries.ArbitrariesFacade with
      net.jqwik.engine.facades.ArbitrariesFacadeImpl;
  provides net.jqwik.api.Arbitrary.ArbitraryFacade with
      net.jqwik.engine.facades.ArbitraryFacadeImpl;
  provides net.jqwik.api.Combinators.CombinatorsFacade with
      net.jqwik.engine.facades.CombinatorsFacadeImpl;
  provides net.jqwik.api.EdgeCases.EdgeCasesFacade with
      net.jqwik.engine.facades.EdgeCasesFacadeImpl;
  provides net.jqwik.api.ExhaustiveGenerator.ExhaustiveGeneratorFacade with
  ...
  provides net.jqwik.api.JavaBeanReportingFormat.JavaBeanReportingFormatFacade with
      net.jqwik.engine.facades.JavaBeanReportingFormatFacadeImpl;
  provides net.jqwik.api.RandomDistribution.RandomDistributionFacade with
      net.jqwik.engine.facades.RandomDistributionFacadeImpl;
  provides net.jqwik.api.RandomGenerator.RandomGeneratorFacade with
  ...
  provides net.jqwik.api.Shrinkable.ShrinkableFacade with
  ...
  provides net.jqwik.api.domains.DomainContext.DomainContextFacade with
      net.jqwik.engine.facades.DomainContextFacadeImpl;
  provides net.jqwik.api.facades.ReflectionSupportFacade with
      net.jqwik.engine.facades.ReflectionSupportFacadeImpl;
  provides net.jqwik.api.facades.ShrinkingSupportFacade with
      net.jqwik.engine.facades.ShrinkingSupportFacadeImpl;
  provides net.jqwik.api.facades.TestingSupportFacade with
      net.jqwik.engine.facades.TestingSupportFacadeImpl;
  ...
  provides net.jqwik.api.lifecycle.Store.StoreFacade with
      net.jqwik.engine.facades.StoreFacadeImpl;
  ...
  provides net.jqwik.api.providers.TypeUsage.TypeUsageFacade with
      net.jqwik.engine.facades.TypeUsageFacadeImpl;
  provides net.jqwik.api.sessions.JqwikSession.JqwikSessionFacade with
      net.jqwik.engine.facades.JqwikSessionFacadeImpl;
  provides net.jqwik.api.statistics.Statistics.StatisticsFacade with
      net.jqwik.engine.facades.StatisticsFacadeImpl;
