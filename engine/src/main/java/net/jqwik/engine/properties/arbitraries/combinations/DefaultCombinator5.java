...
public class DefaultCombinator5<T1 extends @Nullable Object, T2 extends @Nullable Object, T3 extends @Nullable Object, T4 extends @Nullable Object, T5 extends @Nullable Object>
	...
	@Override
	public <R extends @Nullable Object> Arbitrary<R> as(Combinators.F5<? super T1, ? super T2, ? super T3, ? super T4, ? super T5, ? extends R> combinator) {
		return new CombineArbitrary<>(combineFunction(combinator), a1, a2, a3, a4, a5);
	}

	@Override
	public Combinators.Combinator5<T1, T2, T3, T4, T5> filter(Combinators.F5<? super T1, ? super T2, ? super T3, ? super T4, ? super T5, Boolean> filter) {
		return new Filtered<>(a1, a2, a3, a4, a5, filter);
	}

	@SuppressWarnings("unchecked")
	protected <R extends @Nullable Object> Function<List<?>, R> combineFunction(Combinators.F5<? super T1, ? super T2, ? super T3, ? super T4, ? super T5, ? extends R> combinator) {
	...
	private static class Filtered<T1, T2, T3, T4, T5> extends DefaultCombinator5<T1, T2, T3, T4, T5> {
		private final Combinators.F5<? super T1, ? super T2, ? super T3, ? super T4, ? super T5, Boolean> filter;
		...
		private Filtered(
			...
			Arbitrary<T4> a4,
			Arbitrary<T5> a5,
			Combinators.F5<? super T1, ? super T2, ? super T3, ? super T4, ? super T5, Boolean> filter
		) {
		...
		private Combinators.F5<T1, T2, T3, T4, T5, Boolean> combineFilters(
			Combinators.F5<? super T1, ? super T2, ? super T3, ? super T4, ? super T5, Boolean> first,
			Combinators.F5<? super T1, ? super T2, ? super T3, ? super T4, ? super T5, Boolean> second
		) {
