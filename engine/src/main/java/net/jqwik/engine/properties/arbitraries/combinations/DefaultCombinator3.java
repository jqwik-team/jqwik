...
public class DefaultCombinator3<T1 extends @Nullable Object, T2 extends @Nullable Object, T3 extends @Nullable Object>
	...
	@Override
	public <R extends @Nullable Object> Arbitrary<R> as(Combinators.F3<? super T1, ? super T2, ? super T3, ? extends R> combinator) {
		return new CombineArbitrary<>(combineFunction(combinator), a1, a2, a3);
	}

	@Override
	public Combinators.Combinator3<T1, T2, T3> filter(Combinators.F3<? super T1, ? super T2, ? super T3, Boolean> filter) {
		return new Filtered<>(a1, a2, a3, filter);
	}

	@SuppressWarnings("unchecked")
	protected <R extends @Nullable Object> Function<List<?>, R> combineFunction(Combinators.F3<? super T1, ? super T2, ? super T3, ? extends R> combinator) {
	...
	private static class Filtered<T1, T2, T3> extends DefaultCombinator3<T1, T2, T3> {
		...
		private Filtered(Arbitrary<T1> a1, Arbitrary<T2> a2, Arbitrary<T3> a3, Combinators.F3<? super T1, ? super T2, ? super T3, Boolean> filter) {
			super(a1, a2, a3);
			this.filter = filter;
		}
