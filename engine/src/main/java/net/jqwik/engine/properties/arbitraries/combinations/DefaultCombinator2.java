...
public class DefaultCombinator2<T1 extends @Nullable Object, T2 extends @Nullable Object> implements Combinators.Combinator2<T1, T2> {
	...
	@Override
	public <R extends @Nullable Object> Arbitrary<R> as(Combinators.F2<? super T1, ? super T2, ? extends R> combinator) {
	...
	protected <R extends @Nullable Object> Function<? super List<?>, ? extends R> combineFunction(Combinators.F2<? super T1, ? super T2, ? extends R> combinator2) {
		return params -> combinator2.apply((T1) params.get(0), (T2) params.get(1));
	}

	private static class Filtered<T1 extends @Nullable Object, T2 extends @Nullable Object> extends DefaultCombinator2<T1, T2> {
		private final Combinators.F2<? super T1, ? super T2, Boolean> filter;

		private Filtered(Arbitrary<T1> a1, Arbitrary<T2> a2, Combinators.F2<? super T1, ? super T2, Boolean> filter) {
			super(a1, a2);
			this.filter = filter;
		}
