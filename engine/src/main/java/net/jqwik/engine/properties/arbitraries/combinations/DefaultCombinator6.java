...
public class DefaultCombinator6<T1, T2, T3, T4, T5, T6>
	...
	protected <R> Function<List<Object>, R> combineFunction(Combinators.F6<T1, T2, T3, T4, T5, T6, R> combinator) {
	...
	private static class Filtered<T1, T2, T3, T4, T5, T6> extends DefaultCombinator6<T1, T2, T3, T4, T5, T6> {
		private final Combinators.F6<T1, T2, T3, T4, T5, T6, Boolean> filter;
		...
		private Filtered(
			...
			Arbitrary<T5> a5,
			Arbitrary<T6> a6,
			Combinators.F6<T1, T2, T3, T4, T5, T6, Boolean> filter
		) {
		...
		private Combinators.F6<T1, T2, T3, T4, T5, T6, Boolean> combineFilters(
			Combinators.F6<T1, T2, T3, T4, T5, T6, Boolean> first,
			Combinators.F6<T1, T2, T3, T4, T5, T6, Boolean> second
		) {
