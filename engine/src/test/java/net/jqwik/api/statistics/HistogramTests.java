...
class HistogramTests {
	...
	class RangeHistograms {
		...
		void bigIntegerRanges() {
			...
			Assertions.assertThat(report).containsExactly(
				"   # |                                 label | count | ",
				"-----|---------------------------------------|-------|-----------",
				"   0 |  Bigs: [1000000000000..2800000000000[ |    30 | " + bar(1),
				"   1 |  Bigs: [2800000000000..4600000000000[ |    70 | " + bar(3),
				"   2 |  Bigs: [4600000000000..6400000000000[ |   110 | " + bar(5),
				"   3 |  Bigs: [6400000000000..8200000000000[ |   150 | " + bar(7),
				"   4 | Bigs: [8200000000000..10000000000000] |   190 | " + bar(10)
			);
		}
	...
	private String bar(int width) {
		return multiply(Histogram.BOX, width);
	}
