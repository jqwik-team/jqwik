...
class StoreRepositoryTests {
	...
	class Creation {
		...
		void cannotCreateStoreWithNullScope() {
			...
			assertThatThrownBy(() -> repository.create(null, "name", Lifespan.PROPERTY, initializer, null))
		...
		void cannotCreateStoreWithNullIdentifier() {
			Supplier<String> initializer = () -> "a String";
			assertThatThrownBy(() -> repository.create(engine, null, Lifespan.PROPERTY, initializer, null))
				.isInstanceOf(IllegalArgumentException.class);
		}
		...
		void cannotCreateStoreWithNullLifespan() {
			Supplier<String> initializer = () -> "a String";
			assertThatThrownBy(() -> repository.create(engine, "store", null, initializer, null))
				.isInstanceOf(IllegalArgumentException.class);
		}

		@Example
		void cannotCreateStoreWithNullInitializer() {
			assertThatThrownBy(() -> repository.create(engine, "name", Lifespan.PROPERTY, null, null))
				.isInstanceOf(IllegalArgumentException.class);
		}
		...
		void canCreateTwoStoresWithSameNameInDifferentScopes() {
			...
			repository.create(container1, "aString", Lifespan.PROPERTY, () -> "initial", null);

			TestDescriptor container2 = TestDescriptorBuilder.forClass(Container2.class).build();
			repository.create(container2, "aString", Lifespan.PROPERTY, () -> "initial", null);
		...
		void cannotCreateTwoLocalStoresWithSameNameInSameScope() {
			...
			repository.create(container, "aStore", Lifespan.PROPERTY, () -> "initial", null);

			assertThatThrownBy(() -> {
				repository.create(container, "aStore", Lifespan.PROPERTY, () -> 42, null);
		...
		void cannotCreateAnotherLocalStoresWithSameNameInParentScope() {
			...
			repository.create(method1, "aStore", Lifespan.PROPERTY, () -> "initial", null);
	...
	class Retrieval {
		...
		void canBeRetrievedForSameScopeAndSameName() {
			TestDescriptor container = TestDescriptorBuilder.forClass(Container1.class).build();
			ScopedStore<String> store = repository.create(container, "aString", Lifespan.PROPERTY, () -> "initial", null);
			ScopedStore<String> otherStore = repository.create(container, "otherString", Lifespan.PROPERTY, () -> "initial", null);
		...
		void cannotBeRetrievedForSameScopeAndDifferentName() {
			TestDescriptor container = TestDescriptorBuilder.forClass(Container1.class).build();
			repository.create(container, "aString", Lifespan.PROPERTY, () -> "initial", null);
		...
		void cannotBeRetrievedForUnrelatedScopeAndSameName() {
			...
			repository.create(owner, "aString", Lifespan.PROPERTY, () -> "initial", null);
	...
	class Lifecycles_and_Lifespans {
		...
		void finishTry_resetsAllVisibleStoresWithLifespanTry() {
			TestDescriptor container = TestDescriptorBuilder.forClass(Container1.class, "method1").build();
			ScopedStore<String> containerStoreTry = repository.create(container, "containerStoreTry", Lifespan.TRY, () -> "initial", null);
			containerStoreTry.update(s -> "changed");
			ScopedStore<String> containerStoreRun = repository.create(container, "containerStoreRun", Lifespan.RUN, () -> "initial", null);
			containerStoreRun.update(s -> "changed");

			TestDescriptor method = container.getChildren().iterator().next();
			ScopedStore<String> methodStoreTry = repository.create(method, "methodStoreTry", Lifespan.TRY, () -> "initial", null);
			methodStoreTry.update(s -> "changed");
			ScopedStore<String> methodStoreProperty = repository.create(method, "methodStoreProperty", Lifespan.PROPERTY, () -> "initial", null);
			...
			ScopedStore<String> otherContainerStoreTry = repository
				.create(otherContainer, "otherContainerStoreTry", Lifespan.TRY, () -> "initial", null);
		...
		void finishProperty_resetsAllVisibleStoresWithLifespanProperty() {
			...
			ScopedStore<String> containerStoreProperty = repository
				.create(container, "containerStoreProperty", Lifespan.PROPERTY, () -> "initial", null);
			...
			ScopedStore<String> otherContainerStoreProperty = repository
				.create(otherContainer, "otherContainerStoreProperty", Lifespan.PROPERTY, () -> "initial", null);
		...
		void finishScope_removesAllStoresForScopeAndItsChildren() {
			...
			ScopedStore<String> containerStore1 = repository.create(container1, "store1", Lifespan.PROPERTY, () -> "initial", null);
			ScopedStore<String> containerStore2 = repository.create(container1, "store2", Lifespan.PROPERTY, () -> "initial", null);
			ScopedStore<String> method1Store = repository.create(method1, "method1Store", Lifespan.PROPERTY, () -> "initial", null);

			repository.finishScope(container1);

			TestDescriptor container2 = TestDescriptorBuilder.forClass(Container2.class).build();
			ScopedStore<String> container2Store = repository.create(container2, "container2store", Lifespan.PROPERTY, () -> "initial", null);
		...
		void finishScope_callsCloseOnAllRemovedStoreValues() {
			...
			ScopedStore<String> uninitializedMethodStore =
				repository.create(
					...
					Lifespan.PROPERTY,
					() -> "other method value",
					onCloseUninitializedMethodStore
				);
