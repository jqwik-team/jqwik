...
- [DefaultBigDecimalArbitrary](https://github.com/jlink/jqwik/blob/1.2.7/engine/src/main/java/net/jqwik/engine/properties/arbitraries/DefaultBigDecimalArbitrary.java)
- [DefaultStringArbitrary](https://github.com/jlink/jqwik/blob/1.2.7/engine/src/main/java/net/jqwik/engine/properties/arbitraries/DefaultStringArbitrary.java)

Under the hood, most arbitraries use `RandomGenerator`s for the final value generation. Since
[`RandomGenerator`](/docs/1.2.7/javadoc/net/jqwik/api/RandomGenerator.html) 
is a SAM type, most implementations are just lambda expression. 
Start with the methods on
[`RandomGenerators`](https://github.com/jlink/jqwik/blob/1.2.7/engine/src/main/java/net/jqwik/engine/properties/arbitraries/randomized/RandomGenerators.java)
