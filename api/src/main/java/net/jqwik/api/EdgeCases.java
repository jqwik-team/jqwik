...
public interface EdgeCases<T> extends Iterable<Shrinkable<T>> {
	...
	interface Config<T> {
		 ...
		 *
		 * <p>
		 * Some arbitraries may even allow those values to be outside the value range generated by this arbitrary.
		 * But in general you should not do that since it will weaken the semantics
