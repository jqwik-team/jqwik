...
fun <T> Collection<T>.anySubset(): SetArbitrary<T> = Arbitraries.subsetOf(this) as SetArbitrary<T>

/**
 * Convenience function to replace Arbitraries.of(..)
 */
@API(status = API.Status.EXPERIMENTAL, since = "1.7.1")
fun <T> Collection<T>.anyValue(): Arbitrary<T> = Arbitraries.of(this) as Arbitrary<T>
