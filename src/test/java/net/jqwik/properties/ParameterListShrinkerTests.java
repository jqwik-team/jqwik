...
class ParameterListShrinkerTests {
	...
	class Shrink {
		...
		void shrinkToEnd() {
			...
			ParameterListShrinker<Integer> listShrinker = new ParameterListShrinker<>(shrinkableValues, e -> {}, new Reporting[0], ShrinkingMode.FULL);
	...
	class ShrinkNext {
		...
		void noNextShrinkIfNoParameterCanBeShrunk() {
			...
			ParameterListShrinker<Integer> listShrinker = new ParameterListShrinker<>(unshrinkableValues, e -> {}, new Reporting[0], ShrinkingMode.FULL);
