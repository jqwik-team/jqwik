...
class GenericPropertyTests {
	...
	void collectStatistics() {
		...
		PropertyConfiguration configuration = new PropertyConfiguration("Property", 42L, 10, 5, ShrinkingMode.ON, ReportingMode.MINIMAL);
	...
	class OneParameter {
		...
		void satisfied() {
			...
			PropertyConfiguration configuration = new PropertyConfiguration("Property", 42L, 2, 5, ShrinkingMode.ON, ReportingMode.MINIMAL);
		...
		void falsified() {
			...
			PropertyConfiguration configuration = new PropertyConfiguration("Property", 41L, 10, 5, ShrinkingMode.ON, ReportingMode.MINIMAL);
			PropertyCheckResult result = property.check(configuration, NULL_PUBLISHER);
		...
		void dontShrinkIfShrinkingModeIsOff() {
			...
			GenericProperty property = new GenericProperty("falsified property", arbitraries, forAllFunction);
			PropertyConfiguration configuration = new PropertyConfiguration("Property", 41L, 10, 5, ShrinkingMode.OFF, ReportingMode.MINIMAL);
			PropertyCheckResult result = property.check(configuration, NULL_PUBLISHER);
		...
		void exhaustedWithMaxDiscardRatioExceeded() {
			...
			GenericProperty property = new GenericProperty("exhausted property", arbitraries, forAllFunction);
			PropertyConfiguration configuration = new PropertyConfiguration("Property", 42L, 20, maxDiscardRatio, ShrinkingMode.ON, ReportingMode.MINIMAL);
			PropertyCheckResult result = property.check(configuration, NULL_PUBLISHER);
	...
	class ManyParameters {
		...
		void twoParametersSatisfied() {
			...
			PropertyConfiguration configuration = new PropertyConfiguration("Property", 4242L, 5, 5, ShrinkingMode.ON, ReportingMode.MINIMAL);
			PropertyCheckResult result = property.check(configuration, NULL_PUBLISHER);
		...
		void fourParametersFalsified() {
			...
			PropertyConfiguration configuration = new PropertyConfiguration("Property", 4141L, 10, 5, ShrinkingMode.ON, ReportingMode.MINIMAL);
			PropertyCheckResult result = property.check(configuration, NULL_PUBLISHER);
