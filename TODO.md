- 1.5.4
    ...
    - Fix edge case generation of Combinators to allow stateful objects 
      ...
      This should fix problem with edge cases of appending builders. 

    - Fix exhaustive generation of Combinators to allow stateful objects 
      being generated by arbitraries. 
      This should fix problem with exhaustive generation of appending builders. 
