...
public class MinuteRangeForOffsetTimeConfigurator extends ArbitraryConfiguratorBase {
	...
	public Arbitrary<?> configure(Arbitrary<OffsetTime> arbitrary, MinuteRange range) {
		int min = range.min();
		int max = range.max();
